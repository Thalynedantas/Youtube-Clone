...
import { ButtonIcon, Container, Slider, SliderButtons, SliderContent, Button } from './bar-category';
...
function CategoryBar() {
    ...
    const handleNextClick = () => {
        // verifica se a nova posição do slider é menor que a largura total do slider menos a largura do container
    ...
    const categoryButtons = [
        ...
        {name: 'História da civilizações', id: '22'},
        {name: 'Ciências', id: '15'},
        {name: 'Viagens pelo mundo', id: '24'},
        {name: 'Séries', id: '23'},
        {name: 'Novidades', id: '24'},
        {name: 'Educação', id: '1'},
        {name: 'Ciência da tecnologia', id: '2'},
