...
export const InvalidEmailMessege = styled.span<invalidMessegeProps>`
    display: ${({invalid}) => invalid? 'none' : 'block'};
    font-size: 14px;
    color: red;
`;

export const InvalidPasswordMessage = styled.span<invalidMessegeProps>`
    display: ${({invalid}) => invalid? 'none' : 'block'};
    font-size: 14px;
    color: red;
`;
