...
import { MainContainer, SignUpContainer, GoogleLogo, Title, SubTitle, UserNameInput, MessageContainer, InputEmpty, UserEmailInput, PasswordContainer, UserPasswordInput, ComparePassword, PasswordSpan, CheckBoxContainer, ButtonsContainer, SignIn, SignUpButton } from "./style";
                    ...
                    <InputEmpty valid={UserPasswordValid}>
                        {
                            ...
                            :
                            'Senha inválida. Verifique se as senhas estão iguais'
                        }
                    </InputEmpty>
                </MessageContainer>
                <PasswordSpan>
                    Use 8 caracteres com uma combinação de letras, numeros e símbolos.
                </PasswordSpan>
                <CheckBoxContainer>
